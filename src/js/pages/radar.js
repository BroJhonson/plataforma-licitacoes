...
//import { formatDateTime } from '../modules/utils.js'; // Supondo que você moveu para um utilitário

// 2. Envolver toda a lógica da página em uma função principal
export default function initRadarPage() {
    console.log("Página de busca de licitações detectada. Inicializando funcionalidades...");
